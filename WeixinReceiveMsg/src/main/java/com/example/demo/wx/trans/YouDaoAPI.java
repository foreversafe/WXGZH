...
/**
* @author HouZhiBo
* @version 创建时间：2018年11月14日 上午11:29:04
* @ClassName 类名称
* @Description 类描述
*/
...
public class YouDaoAPI {
	public String translate(String q) throws Exception {
		// 应用申请的key
		String appKey = "7b3ed1f310426247";
//        String appKey ="2d156317f9da5d91";
		...
		// 目标语言
		String to = "auto";
//        String keyens="PXwLK5mGbARMsbtjIfpZBM7sDwt40YAL";
		String mishi = "budrDzKdYTju6NjzKzSDdG5lbA4AUHBd";
		// 签名，通过md5(appkey+q+salt+密钥)生成
		String sign = md5(appKey + query + salt + mishi);
	...
	public String requestForHttp(String url, Map requestParams) throws Exception {
		...
		try {
			...
			if (!"".equals(dto.getBasic()) && dto.getBasic() != null) {
				Map<String, Object> basic = dto.getBasic();
				sb.append("词义:");
				for (Entry<String, Object> entry : basic.entrySet()) {
					if(!entry.getKey().equals("uk-speech")&!entry.getKey().equals("us-speech")) {
