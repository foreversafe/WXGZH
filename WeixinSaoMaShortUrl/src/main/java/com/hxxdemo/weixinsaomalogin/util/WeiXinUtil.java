...
public class WeiXinUtil {
	...
	public final static String appid = "wx90dcf00c1aae2b78";
	public final static String appSecret = "9b7b76be077280b2fccf05e0e4925bbb";
	...
	public static String createUrl(String redirectUri) {
		...
		String url = get_userInfo_url.replace("APPID", appid)
				.replace("REDIRECT_URI", CommonUtil.urlEncodeUTF8(redirectUri)).replace("SCOPE", "snsapi_userinfo");
	...
	public static String shortURL(String longURL, String wxAppId, String secret) {
		...
		JSONObject jsonobject = CommonUtil.httpRequest(requestUrl, "POST", String.format(jsonMsg, longURL));
		// 转换成短连接成功
	...
	public static void main(String[] args) {
		...
		String url = "https://open.weixin.qq.com/connect/qrconnect?appid=wx90dcf00c1aae2b78&"
				+ "redirect_uri=http://zhuoxin.nat300.top/index/WeiXinTest&"
				+ "response_type=code&scope=snsapi_login&state=123#wechat_redirect";
		String s = shortURL(url, appid, appSecret);
