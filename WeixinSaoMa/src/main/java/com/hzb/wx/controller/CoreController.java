...
import com.hzb.wx.utils.HttpRequestUtils;
...
public class CoreController {
	...
	public String index(Model model) throws UnsupportedEncodingException {
		...
		model.addAttribute("name", "houzb");
		model.addAttribute("oauthUrl", oauthUrl);
//		model.addAttribute("oauthUrl", "https://open.weixin.qq.com/connect/qrconnect?appid=wxbdc5610cc59c1631&redirect_uri=https%3A%2F%2Fpassport.yhd.com%2Fwechat%2Fcallback.do&response_type=code&scope=snsapi_login&state=3d6be0a4035d839573b04816624a415e#wechat_redirect");
